...
urls = [
    ...
    "https://jobs.dou.ua/vacancies/?relocation&category=Front%20End",
    ...
    # each. It has no AI category of its own, hence the keyword search. keyword-<x>/ pages
    # exist only for real categories: keyword-fastapi/ and keyword-nextjs/ fall back to the
    # unfiltered feed, so those two go through the full-text search.
    "https://djinni.co/jobs/keyword-python/",
    "https://djinni.co/jobs/keyword-fullstack/",
    "https://djinni.co/jobs/keyword-react/",
    "https://djinni.co/jobs/?all_keywords=FastAPI&employment=remote",
